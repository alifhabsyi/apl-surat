                        ...
                        <div class="fresh-datatables">
                            <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                        <?php if($a->STATUS=="KIRIM"){
                                            ?>    
                                        <td> <a href="<?php echo base_url() ?>sk/update_kirim1?n=<?php echo $a->NO_SK ?>" onclick="return checkDelete()" class="btn btn-link btn-warning edit"><i class="fa fa-remove"></i></a>
                                        <?php } else{
                                                echo "<td>$a->STATUS</td>";
                                            }?>    
                                        </td>
