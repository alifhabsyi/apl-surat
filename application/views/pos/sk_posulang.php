...
foreach ($sk as $a) :
    ...
    $no_kirim=$a->NO_KIRIM;
endforeach;
$no_resi=$this->input->get('r');
// var_dump($sk);
?>

<body>

    <h1 align=center>Input Resi Baru</h1>
    <div class="card-body">


        <form class='form-horizontal' id='submit' action="add_posulang" method='post' enctype='multipart/form-data'>

            <div class="row">
                <div class="col-md-4">
                    <input type="text" class="form-control" name="no_resi" id="no_resi" placeholder="Auto Generated Resi" readonly value=<?php echo $no_resi?>>
                </div>
                <div class="col-md-4">

                    <input type="text" class="form-control" name="no_kirim" id="no_kirim" placeholder="Auto Generated No kirim" readonly value=<?php echo $no_kirim?>>
                </div>
                <div class="col-md-4">
