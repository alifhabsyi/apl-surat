<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form class='form-horizontal' id='submit' action="<?php echo base_url() ?>pos/sk_pending" method='post' enctype='multipart/form-data'>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            if ($this->input->post("tahun")) {
                                ...
                                $url = base_url() . "pos/export_sk_pending?t=$tahun&b=$bulan";
